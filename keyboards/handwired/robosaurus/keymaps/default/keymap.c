...
[_QWERTY] = LAYOUT_robosaurus( \
               KC_TAB,    KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,           KC_Y,     KC_U,     KC_I,     KC_O,    KC_P,    KC_BSLS,            \
    KC_ESC,    KC_BSPC,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,           KC_H,     KC_J,     KC_K,     KC_L,    KC_SCLN, KC_QUOT, KC_LEAD,   \
  ...
  [_LOWER]  = LAYOUT_robosaurus( \
             KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,            KC_6,     KC_7,     KC_8,     KC_9,    KC_0,    KC_BSPACE,          \
   _______,  KC_DEL,   KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,  KC_PERC,          KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN, KC_RPRN, _______, _______,   \
             _______,  _______,  _______,  _______,  _______, _______,          _______,  _______,  _______,  _______, _______, _______,            \
                                 _______,  KC_LOWR,  _______, _______,          _______,  _______,  KC_RASE,  _______                               \
  ), \
  [_RAISE]  = LAYOUT_robosaurus( \
              _______,  _______,  _______,  _______,  _______, _______,           _______, KC_MINS,  KC_EQL,   KC_LBRC, KC_RBRC, KC_PIPE,           \
    _______,  _______,  KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,  _______,          KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT, _______, _______, _______,  \
              _______,  _______,  _______,  _______,  _______, _______,          _______,  _______,  _______,  _______, _______, _______,           \
                                  _______,  KC_LOWR,  _______, _______,          _______,  _______,  KC_RASE,  _______                              \
  ), \
  [_ADJUST]  = LAYOUT_robosaurus( \
